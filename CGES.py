...
save_sparsity = []
f=open(r'F:\result\mnist_end\mnist_cges\using_param11.txt','w')
f2=open(r'F:\result\mnist_end\mnist_cges\test_accuracy11.txt','w')
f3=open(r'F:\result\mnist_end\mnist_cges\FLOP11.txt','w')
